    ...
    <div className="flex flex-col md:flex-row w-full max-w-6xl bg-white rounded-2xl shadow-2xl overflow-hidden border border-gray-200">
      ...
      <div className="bg-custom-gradient text-gray-900 p-10 md:w-1/2 flex flex-col justify-center items-center text-center border-r border-gray-200">
        <div className="mb-8">
          ...
          <h1 className="text-3xl font-bold mb-2 text-blue-900">SGII</h1>
      ...
      <div className="p-10 md:w-1/2 flex flex-col justify-center bg-white">
        ...
        >
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className="pl-10 pr-10 w-full px-4 py-3 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-600 input-focus transition duration-200"
          ...
          <div>
            <button
              type="submit"
              className="w-full bg-blue-600 hover:bg-blue-700 text-white font-bold py-3 px-4 rounded-lg transition duration-200 transform hover:scale-105 focus:outline-none focus:ring-2 focus:ring-blue-600 focus:ring-offset-2"
            >
              Entrar
            </button>
          </div>
